...
// relative to a unique header in a crate or in an event.
 ...
 public:
   ...
   PdataLoc ( const char* nm, Int_t cra, Int_t slo, Int_t cha ) :
     ...
     name(nm), ndata(0), search_choice(0), loaded_once(kFALSE) {}
   ...
   PdataLoc ( const char* nm, Int_t cra, UInt_t head, Int_t skip ) :
     ...
     name(nm), ndata(0), search_choice(1), loaded_once(kFALSE) {}
...
// S0 detector
   ...
   Double_t QLIfadcS0A,  QLIfadcS0B;    // L-HRS S0
   Double_t QRIfadcS0A,  QRIfadcS0B;    // R-HRS S0
   Double_t QLIftimeS0A,  QLIftimeS0B;  // L-HRS time over thr S0A, L-HRS S0B
   Double_t QRIftimeS0A,  QRIftimeS0B;  // R-HRS time over thr S0A, R-HRS S0B
   ...
   Double_t QRIfadcS3,  QLIfadcS3;
   Double_t *QLfadcS0A, *QLfadcS0B;  // L-HRS S0
   Double_t *QRfadcS0A, *QRfadcS0B;  // R-HRS S0 

   Double_t *QLfadcS3, *QRfadcS3;  // L-HRS S3, R-HRS S3
   Double_t QLIftimeS3,  QRIftimeS3;  // L-HRS time over thr S3, R-HRS time over thr S3

   /*Double_t urastXL,  urastYL;    // integrated adc L-HRS AT#1 & 2
   Double_t bpmAXPL,  bpmAXML;    // integrated adc R-HRS AT#1 & 2
   Double_t bpmAYPL,  bpmAYML;   // time over thr, L-HRS AT#1 & 2
   Double_t drastXL, drastYL;   // time over thr, R-HRS AT#1 & 2
   Double_t bpmEXPL,  bpmEXML;    // integrated adc R-HRS AT#1 & 2
   Double_t bpmEYPL,  bpmEYML;*/   // time over thr, L-HRS AT#1 & 2
   ...
   void TrigBits(UInt_t hrsnum, UInt_t ibit, PdataLoc *dataloc);
